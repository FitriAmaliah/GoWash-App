...
<div class="flex min-h-screen">
    <aside id="sidebar" class="w-64 bg-indigo-400 p-6 fixed left-0 top-0 h-full z-20 shadow-lg transform transition-transform duration-300 ease-in-out -translate-x-full lg:translate-x-0 overflow-y-auto scrollbar-hide" aria-hidden="true">
        ...
        <ul class="space-y-4">
            ...
            <li>
                <a href="layanan-tersedia" class="flex items-center space-x-3 px-4 py-3 hover:bg-blue-600 rounded">
                    ...
                    <span class="text-white">Layanan Pelanggan</span>
                </a>                
                        <li class="relative">
                            <!-- Dropdown Trigger -->
                            ...
                            <div id="dropdownMenu" class="hidden left-0 mt-1 w-48 bg-indigo-500 text-white rounded-md shadow-lg z-10">
                                <div class="py-1" role="none">
                                    ...
                                    <!-- Riwayat Pemesanan -->
                                    <a href="riwayat-pemesanan" class="flex items-center space-x-3 px-4 py-3 hover:bg-blue-600 rounded">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white">
                            ...
                            <li>
                                <a href="profil-user" class="flex items-center space-x-3 px-4 py-3 text-white hover:bg-blue-500 rounded">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white">
                                ...
                                <li>
                                    <a href="ulasan" class="flex items-center space-x-3 px-4 py-3 text-white hover:bg-blue-500 rounded">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-white">
