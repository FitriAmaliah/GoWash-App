    ...
    <div class="bg-white shadow-md rounded-lg p-5">
        ...
        <div class="container mx-auto">
            ...
            <div class="flex justify-between items-center p-4 mb-6">
                ...
                <!-- Add User Button -->
                <a href="tambah-pengguna" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 flex items-center">
            ...
            <table class="min-w-full leading-normal border border-gray-300">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @foreach ($users as $user)
                        @if ($user->role === 'user') {{-- Hanya tampilkan untuk role user --}}
                        <tr class="hover:bg-gray-100">
                            <!-- Nomor urut menggunakan counter -->
                            <td class="px-6 py-4 text-sm text-gray-900 text-center">{{ $counter }}</td>
                            <td class="px-6 py-4 text-sm text-gray-600 text-center">{{ $user->name }}</td>
                            <td class="px-6 py-4 text-sm text-gray-500 text-center">{{ $user->role }}</td> {{-- Tambahkan warna untuk membedakan --}}
