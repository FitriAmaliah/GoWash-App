...
<body class="min-h-screen flex items-center justify-center bg-indigo-200">
    ...
    <div class="bg-white shadow-md rounded-lg flex w-full max-w-4xl overflow-hidden">
        ...
        <div class="hidden md:flex flex-col items-center justify-center w-1/2 bg-white p-8">
            <img src="/assets/logo-aplikasi.png" alt="Logo Aplikasi" class="h-64 w-64 mb-4"> <!-- Ukuran gambar diperbesar -->
            <h1 class="text-blue-400 text-2xl font-bold">Selamat Datang!</h1>
        </div>
        ...
        <div class="w-full md:w-1/2 p-6">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <!--<div class="text-right mb-4">
                    <a href="forgot-password" class="text-blue-700 hover:text-blue-700">Lupa Kata Sandi?</a>
                </div> -->
                ...
                <div class="text-center mt-4">
                    Belum punya akun?
                    <a href="registrasi" class="text-blue-700 hover:text-blue-700">Daftar di sini</a>
                </div>
            </form>
        </div>
    </div>
